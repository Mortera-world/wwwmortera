        ...
        function updateContent(language) {
            ...
            if (language === 'spanish') {
                content1Element.innerHTML = `
                    ...
                    <p>Al enviar una donación a través de PayPal a mortera World, aceptas los términos presentados en las siguientes 5 afirmaciones con letras (A-E) y sus subsecciones:</p>
                    <ul>
                        <li>A. En ningún momento reclamarás tu pago a mortera World.</li>
                ...
                content1Element.innerHTML = `
                    ...
                    <p>By submitting a donation via PayPal to mortera World, you agree to the terms presented in the following 5, lettered statements (A-E), and their subsections:</p>
                    <ul>
                        <li>A. You will at no time recall your payment from mortera World.</li>
