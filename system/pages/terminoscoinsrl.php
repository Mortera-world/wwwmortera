    ...
    <script>
        ...
        function acceptTermsAndRedirect() {
            ...
            if (acceptCheckbox.checked) {
                window.location.href = 'http://mortera-world.com/?changetc';
            } else {
            ...
            if (language === 'spanish') {
                content1Element.innerHTML = `
                    ...
                    <ul>
                        ...
                        <li>F. La violación continua de las reglas de nuestro servidor conduce a la prohibición de la cuenta, sin importar si se hizo una donación antes. Si rompes las Reglas de mortera, tus donaciones serán invalidadas sin la posibilidad de recompensarte por tu donación si hay un reinicio.</li>
                    </ul>
                `;
            } else {
                content1Element.innerHTML = `
                    ...
                    <ul>
                        ...
                        <li>F. Continuous violation of our server rules leads to account ban, no matter if a donation was made before. If you break mortera Rules, your donations will be invalidated without the possibility of us rewarding you for your donation if there is a reset.</li>
                    </ul>
                `;
            }
        }
