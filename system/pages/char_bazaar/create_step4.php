...
if (!empty($_POST['auction_price']) && !empty($_POST['auction_days'])) {
    ...
    /* ACCOUNT BY PLAYER */
    $getAccount = $db->query('SELECT `id`, `premdays`, `coins_transferable` FROM `accounts` WHERE `id` = ' . $getCharacter['account_id']);
    ...
    $characterVocationId = (int) $getCharacter['vocation'];
    $skillPercents = [
        'axe' => getSkillProgressPercent((int) $getCharacter['skill_axe'], (int) $getCharacter['skill_axe_tries'], 'axe', $characterVocationId),
        'club' => getSkillProgressPercent((int) $getCharacter['skill_club'], (int) $getCharacter['skill_club_tries'], 'club', $characterVocationId),
        'dist' => getSkillProgressPercent((int) $getCharacter['skill_dist'], (int) $getCharacter['skill_dist_tries'], 'dist', $characterVocationId),
        'fishing' => getSkillProgressPercent((int) $getCharacter['skill_fishing'], (int) $getCharacter['skill_fishing_tries'], 'fishing', $characterVocationId),
        'fist' => getSkillProgressPercent((int) $getCharacter['skill_fist'], (int) $getCharacter['skill_fist_tries'], 'fist', $characterVocationId),
        'shielding' => getSkillProgressPercent((int) $getCharacter['skill_shielding'], (int) $getCharacter['skill_shielding_tries'], 'shielding', $characterVocationId),
        'sword' => getSkillProgressPercent((int) $getCharacter['skill_sword'], (int) $getCharacter['skill_sword_tries'], 'sword', $characterVocationId),
    ];
    ?>
                                ...
                                <td>
                                    <div class="TableContentContainer">
                                        <table class="TableContent" style="border:1px solid #faf0d7;" width="100%">
                                            <tbody>
                                            <tr>
                                                <td style="font-weight:normal;"><?= $getAccount['coins_transferable'] ?> <img
                                                    ...
                                                    <table class="TableContent" style="border:1px solid #faf0d7;"
                                                        ...
                                                        <tr class="Even">
                                                            ...
                                                            <div id="SkillBar" class="PercentageBar"
                                                                 style="width: <?= $skillPercents['axe'] ?>%">
                                                                <div class="PercentageBarSpacer"></div>
                                                            </div>
                                                            <div class="PercentageStringContainer"><span
                                                                    class="PercentageString"><?= $skillPercents['axe'] ?> %</span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr class="Odd">
                                                        ...
                                                        <td class="PercentageColumn">
                                                            <div id="SkillBar" class="PercentageBar"
                                                                 style="width: <?= $skillPercents['club'] ?>%">
                                                                <div class="PercentageBarSpacer"></div>
                                                            </div>
                                                            <div class="PercentageStringContainer"><span
                                                                    class="PercentageString"><?= $skillPercents['club'] ?> %</span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr class="Even">
                                                        ...
                                                        <td class="PercentageColumn">
                                                            <div id="SkillBar" class="PercentageBar"
                                                                 style="width: <?= $skillPercents['dist'] ?>%">
                                                                <div class="PercentageBarSpacer"></div>
                                                            </div>
                                                            <div class="PercentageStringContainer"><span
                                                                    class="PercentageString"><?= $skillPercents['dist'] ?> %</span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr class="Odd">
                                                        ...
                                                        <td class="PercentageColumn">
                                                            <div id="SkillBar" class="PercentageBar"
                                                                 style="width: <?= $skillPercents['fishing'] ?>%">
                                                                <div class="PercentageBarSpacer"></div>
                                                            </div>
                                                            <div class="PercentageStringContainer"><span
                                                                    class="PercentageString"><?= $skillPercents['fishing'] ?> %</span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr class="Even">
                                                        ...
                                                        <td class="PercentageColumn">
                                                            <div id="SkillBar" class="PercentageBar"
                                                                 style="width: <?= $skillPercents['fist'] ?>%">
                                                                <div class="PercentageBarSpacer"></div>
                                                            </div>
                                                            <div class="PercentageStringContainer"><span
                                                                    class="PercentageString"><?= $skillPercents['fist'] ?> %</span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr class="Odd">
                                                        ...
                                                        <td class="PercentageColumn">
                                                            <div id="SkillBar" class="PercentageBar"
                                                                 style="width: <?= $skillPercents['shielding'] ?>%">
                                                                <div class="PercentageBarSpacer"></div>
                                                            </div>
                                                            <div class="PercentageStringContainer"><span
                                                                    class="PercentageString"><?= $skillPercents['shielding'] ?> %</span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr class="Odd">
                                                        ...
                                                        <td class="PercentageColumn">
                                                            <div id="SkillBar" class="PercentageBar"
                                                                 style="width: <?= $skillPercents['sword'] ?>%">
                                                                <div class="PercentageBarSpacer"></div>
                                                            </div>
                                                            <div class="PercentageStringContainer"><span
                                                                    class="PercentageString"><?= $skillPercents['sword'] ?> %</span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                        </tbody>
